...
public class Main {
    ...
    private static void iniciarAplicacion() {
        ...
        InscripcionController controlador =
                new InscripcionController(vista);

        try {
            boolean datosCargados =
                    controlador.cargarDatos(RUTA_DATOS);

            if (!datosCargados) {
                crearDatosIniciales(controlador);
                controlador.guardarDatos(RUTA_DATOS);
            }
